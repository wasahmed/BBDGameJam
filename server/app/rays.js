...
startGameEngine = () => {
    ...
    tutorial_canvas.addEventListener('mousemove', mouseMove);
    ...
    class Observer{
        constructor(){
            this.body = new Circle( 500, 500, 10, "white")
            this.ray = []
            this.rayrange = 1000
    ...
    class Player{
        ...
        constructor(){            
            this.body = new Rectangle( 300, 500, 50, 50, "black")
            this.borders = []
            this.xspeed = 0;
            this.yspeed = 0;
            this.maxspeed = 10;
    ...
    for(let mapItem of map){
        let tempRectangle = new Rectangle(mapItem.width,mapItem.height,mapItem.x, mapItem.y, "black")
